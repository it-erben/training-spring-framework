...
public class SampleApplication {
    static void main(String[] args) throws LifecycleException, ServletException {
...
```java
void main(String[] args) throws LifecycleException, ServletException {
    new AnnotationConfigApplicationContext(AppConfig.cl
```
